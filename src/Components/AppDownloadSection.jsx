...
const AppDownloadSection = () => {
  ...
  return (
    <div className="bg-black flex flex-col md:flex-row items-center justify-center p-6 md:p-0 text-white">
      {/* Left Section: Image */}
      <div className="relative flex justify-center mb-6 md:mb-0">
        <img
          src="/images/Hungryphone.png"
      ...
      <div className="text-center md:text-left md:ml-8">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start mt-6 space-y-4 md:space-y-0 space-x-4">
          ...
          {/* Input and Button */}
          <div className="flex md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-4 w-full md:w-auto">
            <input
              type={inputType === "email" ? "email" : "tel"}
              placeholder={inputType === "email" ? "Email" : "Phone"}
              className="border border-gray-300 bg-black text-white rounded-lg px-4 py-2 focus:ring-2 focus:ring-red-500 focus:outline-none w-full md:w-auto"
            />
            <button className="bg-[#ff5200] text-white rounded-lg px-6 py-2 hover:bg-red-600">
              Share App Link
            </button>

...
const CitiesSection = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-40 bg-black text-white">
      {/* Heading */}
      <h2 className="text-2xl font-bold mb-4">Cities with food delivery</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {cities.slice(0, visibleCities).map((city, index) => (
          <button
            key={index}
            className="border border-gray-500 px-4 py-3 rounded-lg text-white hover:bg-gray-700 transition"
          >
            Order food online in {city}
          </button>
        ))}
